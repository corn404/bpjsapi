...
public class BPJSLZString {
    ...
    public static String compressToBase64(String input) {
        ...
        String res = BPJSLZString._compress(input, 6, new CompressFunctionWrapper() {
            @Override
    ...
    public static String decompressFromBase64(final String inputStr) {
        ...
        return BPJSLZString._decompress(inputStr.length(), 32, new DecompressFunctionWrapper() {
            @Override
    ...
    public static String compressToUTF16(String input) {
        if (input == null) return "";
        return BPJSLZString._compress(input, 15, new CompressFunctionWrapper() {
            @Override
            public char doFunc(int a) {
                return fc(a + 32);
            }
    ...
    public static String decompressFromUTF16(final String compressedStr) {
        ...
        return BPJSLZString._decompress(compressedStr.length(), 16384, new DecompressFunctionWrapper() {
            @Override
            public char doFunc(int index) {
    ...
    public static String compressToEncodedURIComponent(String input) {
        if (input == null) return "";
        return BPJSLZString._compress(input, 6, new CompressFunctionWrapper() {
            @Override
            public char doFunc(int a) {
    ...
    public static String decompressFromEncodedURIComponent(String inputStr) {
        ...
        return BPJSLZString._decompress(urlEncodedInputStr.length(), 32, new DecompressFunctionWrapper() {
            @Override
            public char doFunc(int index) {
    ...
    public static String compress(String uncompressed) {
        return BPJSLZString._compress(uncompressed, 16, new CompressFunctionWrapper() {
            @Override
            public char doFunc(int a) {
                return fc(a);
            }
    ...
    public static String decompress(final String compressed) {
        ...
        if (compressed.isEmpty())
            return null;
        return BPJSLZString._decompress(compressed.length(), 32768, new DecompressFunctionWrapper() {
            @Override
